...
(function() {
	...
	// Background.
		(function() {
			...
			new slideshowBackground('bg', {
				...
				images: [
					{
						src: 'assets/images/bg-3e7fd816.jpg',
						position: 'center',
						motion: 'down',
						speed: 2,
						caption: 'Untitled',
	...
	// "On Visible" animations.
		onvisible.add('#text01', { style: 'slide-right', speed: 1000, intensity: 5, delay: 250, staggerOrder: '', state: true, replay: false });
		onvisible.add('#text02', { style: 'slide-right', speed: 1000, intensity: 5, delay: 500, staggerOrder: '', state: true, replay: false });
		onvisible.add('#icons01', { style: 'slide-left', speed: 1000, intensity: 5, delay: 500, stagger: 125, state: true, replay: false });
		onvisible.add('#container02', { style: 'slide-right', speed: 1000, intensity: 5, delay: 250, staggerOrder: '', state: true, replay: false });
